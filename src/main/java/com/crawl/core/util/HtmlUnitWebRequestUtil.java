 ...
 * HttpClient工具类
 */
public class HtmlUnitWebRequestUtil {
    private static Logger logger = LoggerFactory.getLogger(HtmlUnitWebRequestUtil.class);
...
//		InputStream fis = HttpClientUtil.class.getResourceAsStream(name);
    ...
    public static void setCookieStore(CookieStore cookieStore) {
        HtmlUnitWebRequestUtil.cookieStore = cookieStore;
    }
