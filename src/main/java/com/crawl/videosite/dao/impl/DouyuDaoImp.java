...
import com.crawl.videosite.dao.DouyuDao;
...
public class DouyuDaoImp extends DaoImp implements DouyuDao {
    ...
    public static void DBTablesInit() {
        ...
        try {
            //加载properties文件
            p.load(DouyuDaoImp.class.getResourceAsStream("/config.properties"));
