 ...
 */
public class VideoSiteNewUserDetailPageParser implements DetailPageParser {
    ...
    private VideoSiteNewUserDetailPageParser(){
    ...
    public User parseDetailPage(Page page) {
        ...
        user.setUrl("https://www.videosite.com/people/" + userToken);//用户主页
