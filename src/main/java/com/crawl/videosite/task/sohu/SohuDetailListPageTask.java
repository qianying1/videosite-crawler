...
public class SohuDetailListPageTask extends SohuAbstractPageTask {
    ...
    public SohuDetailListPageTask(WebRequest request, boolean proxyFlag) {
    ...
    @Override
    void retry() {
        httpClient.getDetailListPageThreadPool().execute(new SohuDetailListPageTask(request, Config.isProxy));
    }
...
//                        httpClient.getDetailListPageThreadPool().execute(new SohuDetailListPageTask(request, true));
                    }
                }*/
            }
