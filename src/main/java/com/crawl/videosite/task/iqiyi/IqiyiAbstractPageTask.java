 ...
 * @see ProxyPool
 */
public abstract class IqiyiAbstractPageTask implements Runnable {
    private static Logger logger = LoggerFactory.getLogger(IqiyiAbstractPageTask.class);
    ...
    public IqiyiAbstractPageTask() {

    }

    public IqiyiAbstractPageTask(String url, boolean proxyFlag) {
        this.url = url;
        this.proxyFlag = proxyFlag;
    }

    public IqiyiAbstractPageTask(HttpRequestBase request, boolean proxyFlag) {
        ...
        try {
            ...
            if (url != null) {
                if (proxyFlag) {
                    ...
                    currentProxy = ProxyPool.iqiyiProxyQueue.take();
            ...
            if (currentProxy != null && !ProxyUtil.isDiscardProxy(currentProxy)) {
                ...
                ProxyPool.iqiyiProxyQueue.add(currentProxy);
            }
        }
    }
