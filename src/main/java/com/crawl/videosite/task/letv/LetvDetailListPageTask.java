 ...
 * 知乎用户列表详情页task
 */
public class LetvDetailListPageTask extends LetvAbstractPageTask {
    private static Logger logger = LoggerFactory.getLogger(LetvDetailListPageTask.class);
    ...
    public LetvDetailListPageTask(HttpRequestBase request, boolean proxyFlag) {
    ...
    @Override
    void retry() {
        commonHttpClient.getDetailListPageThreadPool().execute(new LetvDetailListPageTask(request, Config.isProxy));
    }
