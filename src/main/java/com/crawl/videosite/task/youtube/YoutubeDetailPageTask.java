 ...
 */
public class YoutubeDetailPageTask extends YoutubeAbstractPageTask {
    private static Logger logger = LoggerFactory.getLogger(YoutubeDetailPageTask.class);
    private static DetailPageParser proxyDetailPageParser;
    static {
        proxyDetailPageParser = getProxyDetailParser();
    }

    public YoutubeDetailPageTask(String url, boolean proxyFlag) {
        super(url, proxyFlag);
    }
