 ...
 * @see ProxyPool
 */
public abstract class YoutubeAbstractPageTask implements Runnable {
    private static Logger logger = LoggerFactory.getLogger(YoutubeAbstractPageTask.class);
    ...
    protected static YoutubeHttpClient httpClient = YoutubeHttpClient.getInstance();

    static {
        videoSiteDao1 = getVideoSiteDao1();
    }

    public YoutubeAbstractPageTask() {

    }

    public YoutubeAbstractPageTask(String url, boolean proxyFlag) {
        this.url = url;
        this.proxyFlag = proxyFlag;
    }

    public YoutubeAbstractPageTask(WebRequest request, boolean proxyFlag) {
        ...
        try {
            ...
            if (url != null) {
                if (proxyFlag) {
                    ...
                    currentProxy = ProxyPool.youtubeProxyQueue.take();
            ...
            if (currentProxy != null && !ProxyUtil.isDiscardProxy(currentProxy)) {
                ...
                ProxyPool.youtubeProxyQueue.add(currentProxy);
            }
        }
    }
