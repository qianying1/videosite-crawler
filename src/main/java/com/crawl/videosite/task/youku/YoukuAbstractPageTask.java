 ...
 * @see ProxyPool
 */
public abstract class YoukuAbstractPageTask implements Runnable {
    private static Logger logger = LoggerFactory.getLogger(YoukuAbstractPageTask.class);
    ...
    public YoukuAbstractPageTask() {

    }

    public YoukuAbstractPageTask(String url, boolean proxyFlag) {
        this.url = url;
        this.proxyFlag = proxyFlag;
    }

    public YoukuAbstractPageTask(HttpRequestBase request, boolean proxyFlag) {
        ...
        try {
            ...
            if (url != null) {
                if (proxyFlag) {
                    ...
                    currentProxy = ProxyPool.youkuProxyQueue.take();
            ...
            if (currentProxy != null && !ProxyUtil.isDiscardProxy(currentProxy)) {
                ...
                ProxyPool.youkuProxyQueue.add(currentProxy);
            }
        }
    }
