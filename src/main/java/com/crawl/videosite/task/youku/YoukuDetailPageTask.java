 ...
 */
public class YoukuDetailPageTask extends YoukuAbstractPageTask {
    private static Logger logger = LoggerFactory.getLogger(YoukuDetailPageTask.class);
    private static DetailPageParser proxyDetailPageParser;
    static {
        proxyDetailPageParser = getProxyDetailParser();
    }

    public YoukuDetailPageTask(String url, boolean proxyFlag) {
        super(url, proxyFlag);
    }
