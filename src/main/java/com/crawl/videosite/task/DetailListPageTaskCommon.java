 ...
 * 知乎用户列表详情页task
 */
public class DetailListPageTaskCommon extends AbstractPageTaskCommon {
    private static Logger logger = LoggerFactory.getLogger(DetailListPageTaskCommon.class);
    ...
    public DetailListPageTaskCommon(HttpRequestBase request, boolean proxyFlag) {
    ...
    @Override
    void retry() {
        commonHttpClient.getDetailListPageThreadPool().execute(new DetailListPageTaskCommon(request, Config.isProxy));
    }
