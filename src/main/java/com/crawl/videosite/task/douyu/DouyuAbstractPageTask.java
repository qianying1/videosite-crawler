 ...
 * @see ProxyPool
 */
public abstract class DouyuAbstractPageTask implements Runnable {
    private static Logger logger = LoggerFactory.getLogger(DouyuAbstractPageTask.class);
    ...
    public DouyuAbstractPageTask() {

    }

    public DouyuAbstractPageTask(String url, boolean proxyFlag) {
        this.url = url;
        this.proxyFlag = proxyFlag;
    }

    public DouyuAbstractPageTask(HttpRequestBase request, boolean proxyFlag) {
        ...
        try {
            ...
            if (url != null) {
                if (proxyFlag) {
                    ...
                    currentProxy = ProxyPool.douyuProxyQueue.take();
            ...
            if (currentProxy != null && !ProxyUtil.isDiscardProxy(currentProxy)) {
                ...
                ProxyPool.douyuProxyQueue.add(currentProxy);
            }
        }
    }
