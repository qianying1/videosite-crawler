 ...
 */
public class PptvHttpClient extends AbstractHttpClient implements IHttpClient {
    ...
    private String initAuthorization() {
        ...
        GeneralPageTask generalPageTask = new GeneralPageTask(Config.pptvStartURL, true);
        generalPageTask.run();
