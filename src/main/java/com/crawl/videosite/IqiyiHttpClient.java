 ...
 */
public class IqiyiHttpClient extends AbstractHtmlUnit implements IHtmlUnit {
    private static Logger logger = LoggerFactory.getLogger(Main.class);
    private volatile static IqiyiHttpClient instance;
    /**
     * 统计用户数量
     */
    ...
    public static IqiyiHttpClient getInstance() {
        if (instance == null) {
            synchronized (IqiyiHttpClient.class) {
                if (instance == null) {
                    instance = new IqiyiHttpClient();
                }
            }
        }
        return instance;
